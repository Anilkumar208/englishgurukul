...
import static com.adobe.aem.englishgurukul.core.utils.PageUtils.appendHtmlToInternalLink;
...
public class ContentBoxModel extends BaseImageModel {

	private static final Logger log = LoggerFactory.getLogger(ContentBoxModel.class);
