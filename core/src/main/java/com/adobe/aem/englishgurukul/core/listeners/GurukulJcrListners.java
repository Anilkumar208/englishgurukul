package com.adobe.aem.englishgurukul.core.listeners;
...
public class GurukulJcrListners implements EventListener {

	private static final Logger log = LoggerFactory.getLogger(GurukulJcrListners.class);
	...
	public void activate() throws Exception {
		try {
			...
			session.getWorkspace().getObservationManager().addEventListener(this, // handler
					Event.NODE_ADDED | Event.PROPERTY_ADDED, // int code for event type
					"/content/englishgurukul/us/en/gurukul", // path
					true, // is Deep?
					null, // UUIDs filter
